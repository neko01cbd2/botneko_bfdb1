...
module.exports.run = async function({ api, event, args, Users, permssion, getText }) {
  ...
  switch (args[0]) {
    ...
    case "list": {
      ...
      return api.sendMessage(`[ 𝗡𝗛𝗔̀ 𝗣𝗛𝗔́𝗧 𝗧𝗥𝗜𝗘̂̉𝗡 ]\n»===================«\n\n𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:Trần Long \n\nFacebook:\n🌏 𝗟𝗶𝗻𝗸: https://www.facebook.com/tranlong222008\nMessenger:\n🌏 𝗟𝗶𝗻𝗸: https://m.me/tranlong222008\n\n[ 𝗔𝗗𝗠𝗜𝗡 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 ]\n»===================«\n\n${msg.join("\n")}\n\n————————🔱————————\n\n[ Người hỗ trợ ]\n»===================«\n\n${msg1.join("\n\n")}`, event.threadID, event.messageID)
    }
    case "add":
    case "a": {
      const permission = ["100086469965492", "100083897637232"];
