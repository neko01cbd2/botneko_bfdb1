...
*/
		...
		// 	// console.log(fdl);
		// 	out({
		// 		body: '➜ Thả cảm xúc "❤️" để gửi âm thanh', attachment: await streamURL(fdl, 'mp4')
