...
var a = Math.floor(Math.random() * 300000) + 100; 
var b = Math.floor(Math.random() * 500000) + 300; 
var c = Math.floor(Math.random() * 200000) + 400; 
var x = Math.floor(Math.random() * 50000) + 80; 
var y = Math.floor(Math.random() * 20000) + 200; 
var f = Math.floor(Math.random() * 20000) + 50; 
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(e.body) {
                ...
                break;
                case "6": msg = `𝐁𝐚̣𝐧 𝐕𝐮̛̀𝐚 𝐍𝐡𝐚̣̂𝐧 ${y}$ 𝐊𝐡𝐢 𝐒𝐨́𝐜 𝐋𝐨̣ 𝐂𝐡𝐨 admin bot 🌚`; 
                await Currencies.increaseMoney(e.senderID, parseInt(y)); 
                break;
                case "5": msg = `𝐊𝐡𝐢 𝐐𝐮𝐚𝐧 𝐇𝐞̣̂ 𝐕𝐨̛́𝐢 𝐓𝐡𝐚𝐧𝐡 𝐍𝐢𝐞̂𝐧 𝐃𝐢́𝐧𝐡 𝐇𝐈𝐕 🎀`; 
