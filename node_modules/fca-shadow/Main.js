...
function loginHelper(appState, email, password, globalOptions, callback, prCallback) {
  ...
  const infoText22 = '━━━━━━━━━━━━━━━[ FCA LOADING ]━━━━━━━━━━━━━━━━';
  const boldInfoText22 = styledText(infoText22, ANSI_BOLD);
  console.log(coloredText(boldInfoText22, ANSI_COLOR_BLACK, ANSI_BACKGROUND_RED));
...
function setUserNameAndPassWord() {
    ...
    console.clear();
    console.log(figlet.textSync('HRZ-MOD', {font: 'ANSI Shadow',horizontalLayout: 'default',verticalLayout: 'default',width: 0,whitespaceBreak: true }));
        ...
        rl.question(Language.TypeAccount, (Account) => {
            if (!Account.includes("@") && global.Fca.Require.utils.getType(parseInt(Account)) != "Number") return logger.Normal(Language.TypeAccountError, function () { process.exit(1) }); //Very Human
                    ...
                    if (global.Fca.Require.FastConfig.ResetDataLogin) {
                        ...
                        global.Fca.Require.fs.writeFileSync(process.cwd() + '/FcaSetting.json', JSON.stringify(global.Fca.Require.FastConfig, null, 4));
                    }
        ...
        if (global.Fca.Require.FastConfig.Websocket_Extension.Status) {
            ...
            if (!UserName || !PassWord || global.Fca.Require.FastConfig.Websocket_Extension.ResetData) {
                ...
                if (!UserName || !PassWord) {
                    ...
                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/FcaSetting.json", JSON.stringify(global.Fca.Require.FastConfig, null, "\t"));
                }
                else {
                    try {
